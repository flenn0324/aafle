...
import { useAddDirigeantMutation } from "../../../../store";
import { useFetchSocietesQuery } from "../../../../store";
import { MenuItem, Select, InputLabel, FormControl } from "@mui/material";
import { Field, ErrorMessage } from "formik";

const AddDirigeant = () => {
  const [addDirigeant, results] = useAddDirigeantMutation();
  ...
  return (
    <Box m="20px">
      <HeadContent
        ...
        subtitle="Ajouter un nouveau dirigeant"
      />
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <TextField
                ...
                error={!!touched.departement_naissance && !!errors.departement_naissance}
                helperText={touched.departement_naissance && errors.departement_naissance}
                sx={{ gridColumn: "span 2" }}
              />
            </Box>
...
const checkoutSchema = yup.object().shape({
  ...
  Département_naissance: yup.string().required("required"),
