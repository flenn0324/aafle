...
import { useUpdateEtablissementMutation } from "../../../../store";
import { useFetchSocietesQuery } from "../../../../store";
import { MenuItem, Select, InputLabel, FormControl } from "@mui/material";
import { Field, ErrorMessage } from "formik";

const UpdateEtablissement = (props) => {
  ...
  const [UpdateEtablissement, results] = useUpdateEtablissementMutation();

  const handleFormSubmit = async (values) => {
    console.log(values);
    await UpdateEtablissement(values);
  ...
  return (
    <Box m="20px">
      <HeadContent
        ...
        subtitle="Modifier les informations d'un établissement"
      />
