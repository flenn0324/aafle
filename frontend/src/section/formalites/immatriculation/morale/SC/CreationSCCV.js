...
const CreationSCCV = (props) => {
  ...
  const handleDownloadPDF = () => {
    ...
    const pdfOptions = {
      margin: 10,
      filename: "Immatriculation SCCV - Creation.pdf",
  ...
  return (
    <Container className="justify-content-center bg-white p-5 border my-5">
      <Helmet>
        <title>Immatriculation SCCV - Création</title>
        <meta
          name="description"
          content="Liste des documents nécessaires et modèles utiles à la constitution de son dossier d’immatriculation d’une société civile de construction vente lors de sa création pour créer sa SCCV et obtenir rapidement un extrait kbis auprès du greffe du Tribunal de commerce
          Téléchargez la liste des documents pour créer une société civile de construction vente lors de sa création, rédigez votre annonce légale et faites votre formalité d’immatriculation en ligne"
        />
        <meta
          name="keywords"
          content="annonces, formalités, creation, societe-civile-de-construction-vente, immatriculation, greffe, kbis, express"
        />
        <link
          rel="canonical"
          href="http://www.formalites-legales.fr/Immatriculation/personne-morale/societe-civile-de-construction-vente-sccv-creation"
        />
      </Helmet>
      <p className="mb-5">
        Accueil
        /Immatriculation/personne-morale/societe-civile-de-construction-vente-sccv-creation
      </p>
      <div id="pdf-content">
