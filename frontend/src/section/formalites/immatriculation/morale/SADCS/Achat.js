...
const Achat = (props) => {
  ...
  const handleDownloadPDF = () => {
    ...
    const pdfOptions = {
      margin: 10,
      filename:
        "Immatriculation SA à Directoire et Conseil de Surveillance - Achat.pdf",
  ...
  return (
    <Container className="justify-content-center bg-white p-5 border my-5">
      <Helmet>
        <title>
          Immatriculation SA à Directoire et Conseil de Surveillance - Achat
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="annonces, formalités, achat, sa-directoire, immatriculation, greffe, kbis, express"
        />
        <link
          rel="canonical"
          href="https://www.formalites-legales.fr/Immatriculation/personne-morale/societe-anonyme-a-directoire-et-conseil-de-surveillance-achat-fonds-de-commerce"
        />
      </Helmet>
      <p className="mb-5">
        Accueil
        /Immatriculation/personne-morale/societe-anonyme-a-directoire-et-conseil-de-surveillance-achat-fonds-de-commerce
      </p>
      <div id="pdf-content">
