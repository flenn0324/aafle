...
const Apport = (props) => {
  ...
  const handleDownloadPDF = () => {
    ...
    const pdfOptions = {
      margin: 10,
      filename:
        "Immatriculation SA à Directoire et Conseil de Surveillance - Apport.pdf",
  ...
  return (
    <Container className="justify-content-center bg-white p-5 border my-5">
      <Helmet>
        <title>
          Immatriculation SA à Directoire et Conseil de Surveillance - Apport
        </title>
        <meta
          name="description"
          content="Liste des documents nécessaires et modèles utiles à la constitution de son dossier d’immatriculation d’une société anonyme à directoire et conseil de surveillance lors l’apport d’un fonds de commerce pour créer sa SA à directoire et obtenir rapidement un extrait kbis auprès du greffe du Tribunal de commerce
          Téléchargez la liste des documents pour créer une SA à directoire et conseil de surveillance lors de l’apport d’un fonds de commerce, rédigez votre annonce légale et faites votre formalité d’immatriculation en ligne"
        />
        <meta
          name="keywords"
          content="annonces, formalités, apport, sa-directoire, immatriculation, greffe, kbis, express"
        />
        <link
          rel="canonical"
          href="https://www.formalites-legales.fr/Immatriculation/personne-morale/societe-anonyme-a-directoire-et-conseil-de-surveillance-apport-fonds-de-commerce"
        />
      </Helmet>
      <p className="mb-5">
        Accueil
        /Immatriculation/personne-morale/societe-anonyme-a-directoire-et-conseil-de-surveillance-apport-fonds-de-commerce
      </p>
      <div id="pdf-content">
        ...
        <div className="my-3">
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">
              Une copie enregistrée de l’acte d’apport de fonds de commerce ;
            </li>
            <li class="list-group-item">
              Un exemplaire original du rapport du Commissaire aux apports ;
            </li>
            <li class="list-group-item">
              La liste des souscripteurs signée par le président ;
            </li>
            <li>
              Une copie enregistrée de l’acte de cession de fonds de commerce ;
            </li>
            <li class="list-group-item">
        ...
        <div className="my-3">
          <h3 className="my-3">
            Pour les membres du Conseil de Surveillance, du Directoire ou le
            Directeur Général unique nommés :
          </h3>
          <ul class="list-group list-group-flush">
            <li class="list-group-item">
