...
const Creation = (props) => {
  ...
  const handleDownloadPDF = () => {
    ...
    const pdfOptions = {
      margin: 10,
      filename: "Immatriculation SELAS - Creation.pdf",
  ...
  return (
    <Container className="justify-content-center bg-white p-5 border my-5">
      <Helmet>
        <title>Immatriculation SELAS - Creation</title>
        <meta
          name="description"
          content="Liste des documents nécessaires et modèles utiles à la constitution de son dossier d’immatriculation d’une société d’exercice libéral par actions simplifiée lors de la création d’un fonds de commerce pour créer sa SELAS et obtenir rapidement un extrait kbis auprès du greffe du Tribunal de commerce
          Téléchargez la liste des documents pour créer une SELAS lors de la création d’un fonds de commerce, rédigez votre annonce légale et faites votre formalité d’immatriculation en ligne"
        />
        <meta
          name="keywords"
          content="annonces, formalités, creation, selas, immatriculation, greffe, kbis, express"
        />
        <link
          rel="canonical"
          href="https://www.formalites-legales.fr/Immatriculation/personne-morale/societe-d-exercice-liberal-par-actions-simplifiee-selas-creation-fonds-de-commerce"
        />
      </Helmet>
      <p className="mb-5">
        Accueil
        /Immatriculation/personne-morale/societe-d-exercice-liberal-par-actions-simplifiee-selas-creation-fonds-de-commerce
      </p>
      <div id="pdf-content">
        <h2 className="text-center mb-3">Immatriculation SELAS - Création</h2>
        <div className="my-3">
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">
            La copie du justificatif de l’autorisation d’exercice de l’activité délivrée par l’autorité compétente aux noms de la société et du Président ;
            </li>
            <li class="list-group-item">
              <li class="list-group-item">
