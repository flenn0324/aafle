...
const Apport = (props) => {
  ...
  const handleDownloadPDF = () => {
    ...
    const pdfOptions = {
        margin: 10,
        filename: 'Immatriculation SARL - Apport.pdf',
  ...
  return (
    <Container className="justify-content-center bg-white p-5 border my-5">
      <Helmet>
        <title>Immatriculation SARL - Apport fonds de commerce</title>
        <meta
          name="description"
          content="Liste des documents nécessaires et modèles utiles à la constitution de son dossier d’immatriculation d’une société à responsabilité limitée lors de l’apport d’un fonds de commerce pour créer son SARL et obtenir rapidement un extrait kbis auprès du greffe du Tribunal de commerce
          Téléchargez la liste des documents pour créer une SARL lors de l’apport d’un fonds de commerce, rédigez votre annonce légale et faites votre formalité d’immatriculation en ligne"
        />
        <meta
          name="keywords"
          content="annonces, formalités, apport, sarl, immatriculation, greffe, kbis, express"
        />
        <link
          rel="canonical"
          href="https://www.formalites-legales.fr/Immatriculation/personne-morale/societe-a-responsabilite-limitee-sarl-apport-fonds-de-commerce"
        />
      </Helmet>
      <p className="mb-5">
        Accueil / immatriculation / personne-morale /
        societe-a-responsabilite-limitee-sarl-apport-fonds-de-commerce
      </p>
      <div id='pdf-content'>
      <h2 className="text-center mb-3">
        Immatriculation SARL - Apport fonds de commerce
      </h2>
        <div className="my-3">
