...
const Creation = (props) => {
  ...
  const handleDownloadPDF = () => {
    ...
    const pdfOptions = {
      margin: 10,
      filename: "Immatriculation SAS - Creation.pdf",
  ...
  return (
    <Container className="justify-content-center bg-white p-5 border my-5">
      <Helmet>
        <title>Immatriculation SAS - Création</title>
        <meta
          name="description"
          content="Liste des documents nécessaires et modèles utiles à la constitution de son dossier d’immatriculation d’une société par actions simplifiée lors de la création d’un fonds de commerce pour créer sa SAS et obtenir rapidement un extrait kbis auprès du greffe du Tribunal de commerce
          Téléchargez la liste des documents pour créer une SAS lors de la création d’un fonds de commerce, rédigez votre annonce légale et faites votre formalité d’immatriculation en ligne"
        />
        <meta
          name="keywords"
          content="annonces, formalités, création, sas, immatriculation, greffe, kbis, express"
        />
        <link
          rel="canonical"
          href="https://www.formalites-legales.fr/Immatriculation/personne-morale/societe-par-actions-simplifiee-sas-creation-fonds-de-commerce"
        />
      </Helmet>
      <p className="mb-5">
        Accueil / immatriculation / personne-morale /
        societe-par-actions-simplifiee-sas-creation-fonds-de-commerce
      </p>
      <div id="pdf-content">
        <h2 className="text-center mb-3">Immatriculation SAS - Création</h2>
        <div className="my-3">
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">
             Un exemplaire certifié conforme par le président de l'acte le désignant, si le président n'est pas nommé dans les statuts et le cas échéant, un exemplaire certifié conforme par le président de l'acte désignant le ou les directeurs généraux ;
            </li>
            <li class="list-group-item">
            Un exemplaire original du certificat du dépositaire des fonds établit par l’organisme où le capital a été déposé ; 
            </li>
            <li class="list-group-item">
