              ...
              <Form className="is-alter" onSubmit={handleSubmit(onFormSubmit)}>
                ...
                <div className="form-group">
                  <div className="form-label-group">
                    ...
                    <Link className="link text-blue link-sm" to={`${process.env.PUBLIC_URL}/pages/auths/auth-forgotpassword`}>
                      Mot de passe oublié?
                    </Link>
                  </div>
                  <div className="form-control-wrap">
                ...
                <div className="form-group">
                  <Button size="lg" className="btn-block bg-blue" type="submit">
                    {loading ? <Spinner size="sm" color="blue" /> : "Se connecter"}
                  </Button>
                </div>
              </Form>
              <div className="form-note-s2 text-center pt-4">
                {" "}
                Nouveau dans la platforme ? <Link className='text-blue' to={`${process.env.PUBLIC_URL}/pages/auths/auth-register`}>Créer un compte</Link>
              </div>
              </div>
            </div>
          </div>
