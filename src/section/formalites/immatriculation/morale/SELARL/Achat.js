...
const Achat = (props) => {
  ...
  const handleDownloadPDF = () => {
    ...
    const pdfOptions = {
      margin: 10,
      filename: "Immatriculation SELARL - Achat.pdf",
  ...
  return (
    <Container className="justify-content-center bg-white p-5 border my-5">
      <Helmet>
        <title>Immatriculation SELARL - Achat</title>
        <meta
          name="description"
          ...
          Téléchargez la liste des documents pour créer une SELARL lors de l’achat d’un fonds de commerce, rédigez votre annonce légale et faites votre formalité d’immatriculation en ligne"
        />
        <meta
          name="keywords"
          content="annonces, formalités, achat, selarl, immatriculation, greffe, kbis, express"
        />
        <link
          rel="canonical"
          href="https://www.formalites-legales.fr/Immatriculation/personne-morale/societe-d-exercice-liberal-a-responsabilite-limitee-selarl-achat-fonds-de-commerce"
        />
      </Helmet>
      <p className="mb-5">
        Accueil
        /Immatriculation/personne-morale/societe-d-exercice-liberal-a-responsabilite-limitee-selarl-achat-fonds-de-commerce
      </p>
      <div id="pdf-content">
        <h2 className="text-center mb-3">Immatriculation SELARL - Achat</h2>
        <div className="my-3">
