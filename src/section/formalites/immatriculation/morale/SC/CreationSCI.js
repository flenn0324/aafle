...
const CreationSCI = (props) => {
  ...
  const handleDownloadPDF = () => {
    ...
    const pdfOptions = {
      margin: 10,
      filename: "Immatriculation SCI - Creation.pdf",
  ...
  return (
    <Container className="justify-content-center bg-white p-5 border my-5">
      <Helmet>
        <title>Immatriculation SCI - Création</title>
        <meta
          name="description"
          content="Liste des documents nécessaires et modèles utiles à la constitution de son dossier d’immatriculation d’une société civile immobilière lors de sa création pour créer sa SCI et obtenir rapidement un extrait kbis auprès du greffe du Tribunal de commerce
          Téléchargez la liste des documents pour créer unesociété civile immobilière lors de sa création, rédigez votre annonce légale et faites votre formalité d’immatriculation en ligne"
        />
        <meta
          name="keywords"
          content="annonces, formalités, creation, societe-civile-immobiliere, immatriculation, greffe, kbis, express"
        />
        <link
          rel="canonical"
          href="https://www.formalites-legales.fr/Immatriculation/personne-morale/societe-civile-immobiliere-sci-creation"
        />
      </Helmet>
      <p className="mb-5">
        Accueil /Immatriculation/personne-morale/societe-civile-immobiliere-sci-creation
      </p>
      <div id="pdf-content">
        <h2 className="text-center mb-3">Immatriculation SCI - Création</h2>
        <div className="my-3">
        ...
        <div className="my-3">
          ...
          <ul  class="list-group list-group-flush">
            <li class="list-group-item">
            Une copie recto-verso d’un justificatif d'identité et de nationalité en cours de validité : le passeport, ou la carte nationale d'identité, ou le titre de séjour.
            </li>
            <li class="list-group-item">
              Un <a>pouvoir ;</a>
            </li>
