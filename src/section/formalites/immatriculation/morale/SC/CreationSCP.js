...
const CreationSCP = (props) => {
  ...
  return (
    <Container className="justify-content-center bg-white p-5 border my-5">
      <Helmet>
        <title>Immatriculation SCP - Création</title>
        <meta
          name="description"
          content="Liste des documents nécessaires et modèles utiles à la constitution de son dossier d’immatriculation d’une société civile professionnelle lors de sa création pour créer sa SCP et obtenir rapidement un extrait kbis auprès du greffe du Tribunal de commerce
          Téléchargez la liste des documents pour créer une société civile professionnelle lors de sa création, rédigez votre annonce légale et faites votre formalité d’immatriculation en ligne"
        />
        <meta
          name="keywords"
          content="annonces, formalités, creation, societe-civile-professionnelle, immatriculation, greffe, kbis, express"
        />
        <link
          rel="canonical"
          href="https://www.formalites-legales.fr/Immatriculation/personne-morale/societe-civile-professionnelle-scp-creation"
        />
      </Helmet>
      <p className="mb-5">
        Accueil /Immatriculation/personne-morale/societe-civile-professionnelle-scp-creation
      </p>
      <div id="pdf-content">
        <h2 className="text-center mb-3">Immatriculation SCP - Création</h2>
        <div className="my-3">
