...
const Achat = (props) => {
  ...
  const handleDownloadPDF = () => {
    ...
    const pdfOptions = {
      margin: 10,
      filename: "Immatriculation EURL - Achat.pdf",
  ...
  return (
    <Container className="justify-content-center bg-white p-5 border my-5">
      <Helmet>
        <title>Immatriculation EURL - Achat</title>
        <meta
          name="description"
          ...
          Téléchargez la liste des documents pour créer une EURL lors de l’achat d’un fonds de commerce, rédigez votre annonce légale et faites votre formalité d’immatriculation en ligne"
        />
        <meta
          name="keywords"
          content="annonces, formalités, achat , eurl, immatriculation, greffe, kbis, express"
        />
        <link
          rel="canonical"
      ...
      <p className="mb-5">
        ...
        /entreprise-unipersonnelle-a-responsabilite-limitee-eurl-achat-fonds-de-commerce
      </p>
      <div id="pdf-content">
        <h2 className="text-center mb-3">
          Immatriculation EURL - Achat
        </h2>
        <div className="my-3">
