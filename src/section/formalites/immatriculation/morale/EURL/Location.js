...
const Location = (props) => {
  ...
  const handleDownloadPDF = () => {
    ...
    const pdfOptions = {
      margin: 10,
      filename: "Immatriculation EURL - Location.pdf",
  ...
  return (
    <Container className="justify-content-center bg-white p-5 border my-5">
      <Helmet>
        <title>Immatriculation EURL - Location Gérance</title>
        <meta
          name="description"
          ...
          Téléchargez la liste des documents pour créer une EURL lors de la location gérance d’un fonds de commerce, rédigez votre annonce légale et faites votre formalité d’immatriculation en ligne"
        />
        <meta
          name="keywords"
          content="annonces, formalités, location gérance , eurl, immatriculation, greffe, kbis, express"
        />
        <link
          rel="canonical"
          href="https://www.formalites-legales.fr/Immatriculation/personne-morale/entreprise-unipersonnelle-a-responsabilite-limitee-eurl-location-gerance-fonds-de-commerce"
        />
      </Helmet>
      <p className="mb-5">
        Accueil / Immatriculation / personne-morale
        /entreprise-unipersonnelle-a-responsabilite-limitee-eurl-location-gerance-fonds-de-commerce
      </p>
      <div id="pdf-content">
        <h2 className="text-center mb-3">
          Immatriculation EURL - Location Gérance
        </h2>
        <div className="my-3">
        ...
        <div className="my-3 page-break">
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item">Les imprimés CERFA 2672</li>
            <li class="list-group-item">
            Une attestation de l’avis de constitution dans un journal d’annonces légales ;
            </li>
            <li class="list-group-item">
              La page de l’avis de location-gérance dans un journal d’annonces
              légales ;
            </li>
