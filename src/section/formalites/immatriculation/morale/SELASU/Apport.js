...
const Apport = (props) => {
  ...
  const handleDownloadPDF = () => {
    ...
    const pdfOptions = {
      margin: 10,
      filename: "Immatriculation SELASU - Apport.pdf",
  ...
  return (
    <Container className="justify-content-center bg-white p-5 border my-5">
      <Helmet>
        <title>Immatriculation SELASU - Apport</title>
        <meta
          name="description"
          content="Liste des documents nécessaires et modèles utiles à la constitution de son dossier d’immatriculation d’une société d’exercice libéral par actions simplifiée unipersonnelle lors de l’apport d’un fonds de commerce pour créer sa SELASU et obtenir rapidement un extrait kbis auprès du greffe du Tribunal de commerce
          Téléchargez la liste des documents pour créer une SELASU lors de l’apport d’un fonds de commerce, rédigez votre annonce légale et faites votre formalité d’immatriculation en ligne"
        />
        <meta
          name="keywords"
          content="annonces, formalités, apport, selasu, immatriculation, greffe, kbis, express"
        />
        <link
          rel="canonical"
          href="https://www.formalites-legales.fr/Immatriculation/personne-morale/societe-d-exercice-liberal-par-actions-simplifiee-unipersonnelle-selasu-apport-fonds-de-commerce"
        />
      </Helmet>
      <p className="mb-5">
        Accueil
        /Immatriculation/personne-morale/societe-d-exercice-liberal-par-actions-simplifiee-unipersonnelle-selasu-apport-fonds-de-commerce
      </p>
      <div id="pdf-content">
        <h2 className="text-center mb-3">Immatriculation SELASU - Apport</h2>
        <div className="my-3">
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">
              Un exemplaire de la décision de l’associé unique de désignation
            ...
            <li class="list-group-item">
              ...
              société et du Président ;
            </li>
          </ul>
        </div>
        <div className="my-3">
          <h3 className="my-3">
            Pour le Président et les Directeurs Généraux nommés :
          </h3>
          <ul class="list-group list-group-flush">
            <li class="list-group-item">
