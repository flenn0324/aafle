...
const Creation = (props) => {
  ...
  const handleDownloadPDF = () => {
    ...
    const pdfOptions = {
      margin: 10,
      filename:
        "Immatriculation SA à Directoire et Conseil de Surveillance - Creation.pdf",
  ...
  return (
    <Container className="justify-content-center bg-white p-5 border my-5">
      <Helmet>
        <title>
          Immatriculation SA à Directoire et Conseil de Surveillance - Creation
        </title>
        <meta
          name="description"
          content="Liste des documents nécessaires et modèles utiles à la constitution de son dossier d’immatriculation d’une société anonyme à directoire et conseil de surveillance lors la création d’un fonds de commerce pour créer sa SA à directoire et obtenir rapidement un extrait kbis auprès du greffe du Tribunal de commerce
          Téléchargez la liste des documents pour créer une SA à directoire et conseil de surveillance lors de la création d’un fonds de commerce, rédigez votre annonce légale et faites votre formalité d’immatriculation en ligne"
        />
        <meta
          name="keywords"
          content="annonces, formalités, creation, sa-directoire, immatriculation, greffe, kbis, express"
        />
        <link
          rel="canonical"
          href="https://www.formalites-legales.fr/Immatriculation/personne-morale/societe-anonyme-a-directoire-et-conseil-de-surveillance-creation-fonds-de-commerce"
        />
      </Helmet>
      <p className="mb-5">
        Accueil
        /Immatriculation/personne-morale/societe-anonyme-a-directoire-et-conseil-de-surveillance-creation-fonds-de-commerce
      </p>
      <div id="pdf-content">
        <h2 className="text-center mb-3">
          Immatriculation SA à Directoire et Conseil de Surveillance - Création
        </h2>
        <div className="my-3">
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">
              Un exemplaire du procès-verbal du conseil de surveillance nommant
              les Président et vice-président du conseil de surveillance, ainsi
              que les membres du directoire, certifié conforme par le
              représentant légal, le directeur général unique, le cas échéant ;
            </li>
            <li class="list-group-item">
            ...
            <li>
              ...
              disposition dans le cas où le siège social est fixé à l’adresse de
              l’un des dirigeants ;
            </li>
            <li class="list-group-item">
        ...
        <div className="my-3">
          <h3 className="my-3">Pour les membres du Conseil de Surveillance, du Directoire ou le Directeur Général unique nommés :</h3>
          <ul class="list-group list-group-flush">
            <li class="list-group-item">
        ...
        <div className="my-3 page-break">
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item">Une attestation de l’avis de constitution dans un journal d’annonces légales ;</li>
