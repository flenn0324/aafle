...
const Achat = (props) => {
  ...
  const handleDownloadPDF = () => {
    ...
    const pdfOptions = {
      margin: 10,
      filename: "Immatriculation SAS - Achat.pdf",
  ...
  return (
    <Container className="justify-content-center bg-white p-5 border my-5">
      <Helmet>
        ...
        <meta
          name="description"
          content="Liste des documents nécessaires et modèles utiles à la constitution de son dossier d’immatriculation d’une société par actions simplifiée lors de l’achat d’un fonds de commerce pour créer sa SAS et obtenir rapidement un extrait kbis auprès du greffe du Tribunal de commerce
          Téléchargez la liste des documents pour créer une SAS lors de l’achat d’un fonds de commerce, rédigez votre annonce légale et faites votre formalité d’immatriculation en ligne"
        />
        <meta
          name="keywords"
          content="annonces, formalités, achat, sas, immatriculation, greffe, kbis, express"
        />
        <link
          rel="canonical"
      ...
      <p className="mb-5">
        Accueil
        /Immatriculation/personne-morale/societe-par-actions-simplifiee-sas-creation-fonds-de-commerce
      </p>
      <div id="pdf-content">
        <h2 className="text-center mb-3">Immatriculation SAS - Achat</h2>
        <div className="my-3">
