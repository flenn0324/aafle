        ...
        <Section className={props.className && props.className} id={props.id && props.id}>
            <Container>
                <Row className="align-items-center justify-content-between g-gs">
                    ...
                    <Col lg="6">
                        <TextBlock>
                            <TitleH2>A propos de nous :</TitleH2>
                            ...
                            <ul className="btns-inline">
                                <li><Link to="#prqnouschoisir" target="_blank" rel="noreferrer" className="btn-lg bg-blue text-white"><span>Voir plus</span></Link></li>
                            </ul>
                        </TextBlock>
                    </Col>
                </Row>
